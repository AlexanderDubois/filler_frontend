...
class SignUpScreen extends React.Component {
    ...
    addImage = async () => {
        ...
        if (!result.cancelled) {
            this.setState({profile_img: result})
        }  
    }
